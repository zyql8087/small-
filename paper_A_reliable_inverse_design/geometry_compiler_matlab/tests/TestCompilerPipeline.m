...
%TESTCOMPILERPIPELINE Tests request parsing and compiler orchestration.
    ...
    methods (Test)
        ...
        function testProductionM1CompilerIsByteDeterministic(testCase)
            ...
            testCase.verifyEqual(firstResponse.artifacts.manifest_sha256, ...
                sha256_file(firstResponse.artifacts.manifest_path, ...
                'MATLABGyroid:TestFailure', 'published manifest'));
