...
IMG_CANOPY = str(PROJECT_ROOT / "external" / "GenerateOrigamiDataSet" / "Figures_ReadMe" / "CanopyDetails.png")
IMG_FWD_LOSS = str(EXPERIMENT_ROOT / "model_audit" / "loss_curves_final" / "forward_transformer_loss.png")
IMG_FWD_NRMSE = str(EXPERIMENT_ROOT / "results_final_model_test" / "figures" / "forward_overall_nrmse.png")
IMG_INV_NRMSE = str(EXPERIMENT_ROOT / "results_final_model_test" / "figures" / "inverse_closed_loop_nrmse.png")
IMG_SHOWCASE = str(EXPERIMENT_ROOT / "results_final_model_test" / "prediction_showcase" / "forward_transformer_good_case_1_sample_165.png")
...
# Save
output_path = str(EXPERIMENT_ROOT / "reports" / "组会汇报_v3_final.pptx")
